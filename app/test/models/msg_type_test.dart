...
void main() {
  ...
  group('MsgType.compactDivider', () {
    ...
    test('fromString compact_divider 返回枚举', () {
      expect(MsgTypeX.fromString('compact_divider'), MsgType.compactDivider);
    });

    test('round-trip: value → fromString 回到原值', () {
      expect(MsgTypeX.fromString(MsgType.compactDivider.value), MsgType.compactDivider);
    });
  });
}
