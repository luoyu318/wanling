...
万灵 Flutter APP,3-tab IM 风格(消息/万灵/我的),仅 Android 发布。Claude Code 在 app/ 目录工作时自动加载本文件 + 根 CLAUDE.md。

## 子系统身份

Flutter APP,3-tab IM 风格(消息/万灵/我的),**仅 Android 发布**(Linux desktop 不支持)。
...
flowchart TB
    ...
    ROUTER[router.dart<br/>3-tab 保活]
        PAGES[27 个 pages]
