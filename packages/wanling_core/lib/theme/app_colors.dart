...
class AppColors {
  ...
  // —— Markdown 渲染色（接收方白底场景）——
  /// 正文（接收方气泡）
  static const Color mdBody = Color(0xFF2D3748);

  /// H1 标题（最深墨蓝）
  static const Color mdH1 = Color(0xFF1A365D);

  /// H2 标题 + 加粗 strong（墨蓝）
  static const Color mdH2 = Color(0xFF2C5282);

  /// H3/H4 标题（中蓝）
  static const Color mdH3 = Color(0xFF2B6CB0);

  /// H5/H6 标题 + 引用块文字（灰蓝）
  static const Color mdH5 = Color(0xFF4A5568);

  /// 链接 + 行内代码（品牌绿）
  static const Color mdLink = Color(0xFF00B176);

  /// 分割线渐变起点（蓝→透明）
  static const Color mdHr = Color(0xFF3182CE);

  /// 引用块左侧边线（墨蓝）
  static const Color mdQuoteSide = Color(0xFF2C5282);
}
