...
### HTTP Handler(14 个)
- `internal/handler/` — HTTP Handler 集合,涵盖 auth/user/agent/conversation/approval/ws/send/message/file/pairing + middleware/access_log。详见 [handlers.md](./server/handlers.md)
