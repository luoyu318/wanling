...
![消息会话列表](docs/images/消息会话列表主界面.jpg)
...
| 审批通知 | 子Agent审批卡片 | 问答 | 安全审批 | OpenCode 项目 | OpenCode 会话列表 | 文件预览 |
|---|---|---|---|---|---|---|
| <img src="docs/images/权限审批通知.jpg" width="170" alt="权限审批通知"/> | <img src="docs/images/opencode-审批卡片.jpg" width="170" alt="子Agent审批卡片"/> | <img src="docs/images/问答抽屉.jpg" width="170" alt="问答抽屉"/> | <img src="docs/images/权限审批抽屉.jpg" width="170" alt="权限审批抽屉"/> | <img src="docs/images/opencode项目列表.jpg" width="170" alt="opencode 项目列表"/> | <img src="docs/images/opencode会话列表.jpg" width="170" alt="opencode 会话列表"/> | <img src="docs/images/文件资源管理器-文件预览.jpg" width="170" alt="文件预览"/> |
